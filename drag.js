...
function dragStart(e) {
  ...
  posPrev = findLayer(draggableItem)
  console.log("EMPIEZA EN LA POS: ", posPrev)
  Photopea.runScript(wnd, `app.activeDocument.activeLayer = app.activeDocument.layers.getByName("${draggableItem.getElementsByClassName('layerName')[0].textContent}");`);
